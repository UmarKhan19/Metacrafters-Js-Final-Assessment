...
mintNFT("NFT 1", "Blue", "Hoodie", "Silver Chain");
mintNFT("NFT 2", "Green", "Hoodie", "Bronze Chain");
mintNFT("NFT 3", "Red", "Hoodie", "Gold Chain");
mintNFT("NFT 4", "Yellow", "Hoodie", "Titanium Chain");
mintNFT("NFT 5", "Pink", "Hoodie", "Copper Chain");
